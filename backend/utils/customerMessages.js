  ...
  <div style="margin:0;padding:0;background:#f7f3ec">
    <div style="max-width:680px;margin:0 auto;padding:24px 12px">
      ...
      <div style="background:#fff;border:1px solid #eadfc7;border-top:0;border-radius:0 0 12px 12px;padding:22px">
        ...
        <p style="margin:18px 0 0;color:#8a8178;font:12px/1.5 Arial,sans-serif">For any inquiry, payment issue, booking help, order support, or cancellation assistance, contact support at +91 8218303066 or vrindavansarthi108@gmail.com. This email was generated by Vrindavan Sarthi Enterprises; please keep it for your records.</p>
      </div>
    </div>
  </div>
`;
